def caesar_cipher(string, shift)
  ...
  # Here we compare each character in the inital string and return the shifted character or leave it if it does not appear in lower/upper letters
  # The modulus division by 26 is used to reset to the beginning of the alphabet since it will provide the remainder once it goes past the index of z
